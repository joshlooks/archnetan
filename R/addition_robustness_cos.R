#' Adds noise (in the form of full data points) and then create cosine-similarity communities from an inputted dataset
#'
...
#' @examples
#' \dontrun{
#' cos_communities_single(df_graph, "Source", "Site", proportion=0.2, numReps=50)
#' }
...
#' Adds noise (by drawing each variable independently) and then create cosine-similarity communities from an inputted dataset
#'
#' @param df Dataframe original frequency graph
#' @param col1 A string of the first column used to make graphs
#' @param col2 A string of the second column used to make graphs
...
#' @examples
#' \dontrun{
#' cos_communities_multi(df_graph, "Source", "Site", proportion=0.2, numReps=50)
#' }
...
#' Runs cos_communities_single or cos_communities multiple over a range of proportions and aggregates Hamming distances
#'
#' @param df Dataframe original frequency graph
#' @param col1 A string of the first column used to make graphs
#' @param col2 A string of the second column used to make graphs
...
#' @examples
#' \dontrun{
#' create_added_noise_cos_communities(df_graph, "Source", "Site",
#' proportion=c(0.2,0.3,0.4,0.5), numReps=50, method="multi", propSave=0.5)
#' }
create_added_noise_cos_communities <- function(df, col1, col2, proportion=0.10, numReps=100, method='single', propSave=0.10){
